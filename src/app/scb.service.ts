...
export class ScbService {
  ...
  private baseUrl = 'https://southeastasia.api.cognitive.microsoft.com/face/v1.0';
  // apiURL: string = 'https://1teamapi.azurewebsites.net';
  apiURL: string = 'https://scbapi.azurewebsites.net/';
  ...
  getBloblist(){
    return this.http.get(`https://noblesamplebot9711.blob.core.windows.net/?comp=list`, httpOptions);
  ...
  InsertDB(empid,fname,lname,fid){
    let request = { empid:empid,fname:fname,lname:lname,fid:fid };
    return this.http.post<any>(`${this.apiURL}/signup`, { empid:empid,fname:fname,lname:lname,fid:fid }, httpOptionsq);
  }
...
const httpOptions = {
  headers: new HttpHeaders({
    ...
    'Ocp-Apim-Subscription-Key': '8b1838e13407455daf92a98bd51016ba'
  })
};
